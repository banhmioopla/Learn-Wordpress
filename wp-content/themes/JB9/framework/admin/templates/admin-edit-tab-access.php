...
<div id="message" class="updated below-h2" style="margin-top:30px;"><b>Remember:</b> You can limit based on membership access using the shortcode: [MEMBERSHIP] <br><br><b>Example:</b><br><textarea style="width:100%;height:50px;padding:10px;">[MEMBERSHIP ID="1,2,3"] Your here will show only for membership ID 1,2 and 3[/MEMBERSHIP] </textarea> <br><br>Use ID 0 for non-registered users or non-members. </div> 