                ...
                <?php if ($order_type == 'auto')
                        {
                           ?>
                            <div class="atto_metabox">
                               ...
                               <h4 class="ntitle"><?php _e('Order By', 'atto') ?></h4>
                                                ...
                                                <label class="control-label col-7"><?php _e('Default', 'atto') ?></label>                                                
                                                </div>
                                                ...
                                                <label class="control-label col-7"><?php _e('Creation Time / ID', 'atto') ?></label> 
                                                </div>
                                                ...
                                                <label class="control-label col-7"><?php _e('Name', 'atto') ?></label>
                                                </div>
                                               ...
                                               <?php /*
                                                ...
                                                <label class="control-label col-7"><?php _e('Count', 'atto') ?></label>
                                                </div>
												...
												*/ ?>                                               
                                                ...
                                                <label class="control-label col-7"><?php _e('Slug', 'atto') ?></label>
                                                </div>
                                                ...
                                                <label class="control-label col-7"><?php _e('Random', 'atto') ?></label>
                                                </div>
                                                */ ?>
                                                
                                                
                                                 
                                      <h4 class="ntitle"><?php _e('Order', 'atto') ?></h4>
                                                <?php
                                                ...
                                                <label for="order_desc"><?php _e('Descending', 'atto') ?></label>
                                                </div>
                                            ...
                                            <div class="alignright actions">
                                                <p class="actions">
                                                    ...
                                                    <span class="img_spacer">&nbsp;
                                                        <img alt="" src="<?php echo wlt_orderby_URL ?>/images/wpspin_light.gif" class="waiting pto_ajax_loading" style="display: none;">
                                                    </span>
