...
function hook_v9_admin_edit_options(){ do_actions('hook_v9_admin_edit_options'); }


function hook_v9_corefuns($c){ return  apply_filters('hook_v9_corefuns', $c); }


function hook_v9_order_process($c){ return  apply_filters('hook_v9_order_process', $c); }

function hook_v9_advancedsearchfield_display($c){ return  apply_filters('hook_v9_advancedsearchfield_display', $c); }
 
function hook_v9_extra_css($c){ return  apply_filters('hook_v9_extra_css', $c); }
function hook_v9_extra_css_mobile($c){ return  apply_filters('hook_v9_extra_css_mobile', $c); }
...
function hook_v9_admin_email_options($c){ return  apply_filters('hook_v9_admin_email_options', $c); } // used in 3 overview


function hook_v9_admin_elementor_templates($c){ return  apply_filters('hook_v9_admin_elementor_templates', $c); } // used in 3 overview

function hook_v9_account_top(){  do_action('hook_v9_account_top');   } // used in tpl-account
function hook_v9_single_top(){  do_action('hook_v9_single_top');   } // used in tpl-account
...
function hook_main_after(){  do_action('hook_main_after');   }
...
function hook_content_templatename($c){ return  apply_filters('hook_content_templatename', $c);  }
	...
	// ADMIN 1
	function hook_admin_10_tabs($c){   return  apply_filters('hook_admin_10_tabs', $c);   }
  	function hook_admin_10_content(){  do_action('hook_admin_10_content');  }
