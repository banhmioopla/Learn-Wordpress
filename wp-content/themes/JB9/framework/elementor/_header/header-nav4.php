...
?>
<nav class="elementor_header elementor_nav header-nav4 pptv9-header <?php if(isset($settings['class'])){ echo $settings['class']; } ?>">
  <div class="clearfix">
      <div class="container">
         <nav class="pptv9-menu float-none separate-line submenu-scale text-left">
         <?php ob_start(); ?>
         ...
         <?php
            $addon = ob_get_clean();
                     ?>
         <nav class="pptv9-menu float-none  text-left">
            <?php 
               ob_start();	
