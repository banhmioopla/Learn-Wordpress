<?php 
   ...
   */
   ...
   ?>
<div class="elementor_header elementor_logo header-logo2 header-logo4 <?php if(!isset($settings['sticky'])){ ?>no-sticky<?php } ?> <?php if(isset($settings['class'])){ echo $settings['class']; } ?>">
   <div class="container py-4">
      <div class="row">
         ...
         <div class="col-12 col-lg-5 d-none d-lg-block">
            ...
            <?php }else{ ?>
            <form action="<?php echo get_home_url(); ?>/" method="get" name="searchform1" <?php if(!isset($settings['searchformname'])){ ?>id="searchform1"<?php }else{ ?>name="<?php echo $settings['searchformname']; ?>" id="<?php echo $settings['searchformname']; ?>"<?php } ?>>
                  ...
                  <div class="input-group">
                     <div class="input-group-addon dropdown hidden-md-down">
                       ...
                       <?php if(!isset($settings['hide_categories'])){ ?>
                        <a class="nav-link dropdown-toggle bg-white" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" id="searchform_title"><?php echo __("Categories","premiumpress") ?></a>
