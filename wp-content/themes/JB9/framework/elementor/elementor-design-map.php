...
class Widget_PremiumPress_Map extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( '{ Google Map }', 'premiumpress-elementor' );
	} 
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Map Block', 'premiumpress-elementor' ),
	...
	protected function render() { global $userdata, $CORE, $settings;
		...
		get_template_part('framework/elementor/_cmap/cmap-1'); 
