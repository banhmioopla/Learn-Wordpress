...
<div class="col-md-3 pr-lg-0">
    ...
    <a href="<?php echo $settings['img2_link']; ?>">
        <img src="<?php if(isset($settings['img2']) && strlen($settings['img2']) > 1 ){ echo $settings['img2']; }else{ ?>http://via.placeholder.com/272x249<?php } ?>" class="img-fluid" alt="image" />
    </a>   
    </div>
...
<div class="col-md-3">
    ...
    <a href="<?php echo $settings['img4_link']; ?>">
        <img src="<?php if(isset($settings['img4']) && strlen($settings['img4']) > 1 ){ echo $settings['img4'];}else{ ?>http://via.placeholder.com/257x515<?php } ?>" class="img-fluid" alt="image" />
    </a>   
    </div>
