...
?>
<div id="hero-2" class="owl-slider hero-2 hero-37">
	...
	<div class="text-area">
                     ...
                     <a href="<?php if(isset($settings['img1_btnlink'])){ echo $settings['img1_btnlink']; } ?>" class="btn btn-secondary px-5 text-left rounded-0 py-3 mt-lg-4">
	...
	<div class="text-area">
    				...
    				<?php if(isset($settings['img2_txt1'])){ ?>
                     ...
                     <a href="<?php if(isset($settings['img2_btnlink'])){ echo $settings['img2_btnlink']; } ?>" class="btn btn-secondary px-5 text-left rounded-0 py-3 mt-lg-4">
	...
	<div class="text-area">
                     ...
                     <a href="<?php if(isset($settings['img3_btnlink'])){ echo $settings['img3_btnlink']; } ?>" class="btn btn-secondary px-5 text-left rounded-0 py-3 mt-lg-4">
