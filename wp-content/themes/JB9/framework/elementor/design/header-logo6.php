...
<div class="ppt-header header-1 header-logo6 <?php if(!isset($settings['sticky'])){ ?>no-sticky<?php } ?> <?php if(isset($settings['class'])){ echo $settings['class']; } ?>" <?php if(isset($settings['id'])){ echo "id='".$settings['id']."'"; } ?>>
         ...
         <?php if( _ppt(array('links','myaccount')) != ""){ ?>
            <div class="hicons row float-right mt-3">
               <div class="phonebox">
                  ...
                  <span class="iconsmall"><i class="fa fa-user-circle text-secondary"></i></span>
                  <span class="content mr-3">
