<?php global $CORE, $userdata, $wpdb, $settings;
   ?>
<nav class="header-nav2 <?php if(isset($settings['class'])){ echo $settings['class']; } ?>">
<div class="container">
   <div class="row">
      <div class="col-md-8">
         <nav class="ppt-menu float-none text-left mt-2">
      ...
      <div class="col-12 col-lg-4">
         ...
         <?php }else{ ?>
         <form action="<?php echo get_home_url(); ?>/" method="get" name="" id="searchform1" class="mt-lg-3">
