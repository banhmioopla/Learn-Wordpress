         ...
         <div class="row">
            ...
            <div class="col-md-4 d-none d-lg-block">
               <div class="hicons row float-right mt-1">
                  ...
                  <a href="<?php echo _ppt(array('links','cart')); ?>" class="mx-4 text-dark">
                     <div class="icon icon-cart"> 
                        <span class="count bg-secondary cart-basket-count"><?php echo $c2; ?></span> 
                     </div>
                     <div class="small text-uppercase"><?php echo __("Basket","premiumpress"); ?></div>
                  </a>
               </div>
            </div>
         </div>
