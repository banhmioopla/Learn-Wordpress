<?php global $CORE, $userdata, $wpdb, $settings; 
 ...
 if(isset($settings['img3']) && is_array($settings['img3'])){ $settings['img3'] = $settings['img3']['url']; }
 
?>
<div class="cimgbox3 row">
    ...
    <div class="banner-boder-zoom">
            ...
            <img src="<?php if(isset($settings['img3']) && !is_array($settings['img3']) && $settings['img3'] != ""){ 
