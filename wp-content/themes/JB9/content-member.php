...
<div class="member box-grey box-shadow bg-light pb-4 mb-4">
   <div class="box-grey-wrap">
      ...
      <h4 class="text-center"> <a href="<?php echo get_author_posts_url( $user->ID ); ?>" class="text-dark" style="text-decoration:underline;"><?php echo $CORE->user_display_name($user->ID); ?></a></h4>
      <div class="text-center">
         <div class="font-size14 grey"><?php echo __("Member since","premiumpress"); ?></div>
         <div class="font-size12 grey margin-top1"><?php $gg = hook_date($user->user_registered); $f = explode(":", $gg); echo substr($f[0], 0, -2);  ?></div>
      </div>
   </div>
</div>