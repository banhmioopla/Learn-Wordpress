<?php
   ...
   */
   ...
   if(!_ppt_checkfile("search-top.php")){ 
...
<form action="<?php echo get_home_url(); ?>/" method="get" name="mainsearchfilters" id="mainsearchfilters" class="clearfix" style="position:relative;">
   ...
   <div class="row mb-4">
      <div class="col-7 col-md-8">
         <div class="results-title font-weight-bold">
            ...
            <?php if(isset($_GET['s']) && strlen($_GET['s']) > 0){ ?>
            <?php echo __("Results For","premiumpress"); ?> 
            <strong><?php echo esc_attr($_GET['s']); ?></strong> 
            <?php }elseif(isset($GLOBALS['flag-taxonomy-type'])){ $term = get_term_by('slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); 
               ?>
            <?php echo __("Results In Category","premiumpress"); ?>  <strong><?php echo $term->name; ?></strong> 
            <?php }else{ ?>
            <?php echo __("Results Found","premiumpress"); ?> 
            <?php } ?>
         </div>
      </div>
      <div class="col-5 col-md-4">
     <?php  if(_ppt('page_columns') != 1){ ?>
         <div class="listing-view-layout">
            <ul>
               <li><a class="grid <?php if(!isset($_GET['display']) && in_array(THEME_KEY, array("da","at","rt","sp","mj","cm","vt","so")) || isset($_GET['display']) && $_GET['display'] == 0){ echo "active"; } ?>" href="#" onclick="switchlayout(0);" ><i class="fa fa-th-large"></i></a></li>
               <li><a class="list <?php  if(!isset($_GET['display']) && !in_array(THEME_KEY, array("da","at","rt","sp","mj","cm","vt","so")) || isset($_GET['display']) && $_GET['display'] == 1){ echo "active"; } ?>" href="#" onclick="switchlayout(1);"><i class="fa fa-list-ul"></i></a></li>
               <li><a class="list hide-mobile <?php if(isset($_GET['display']) && $_GET['display'] == 2){ echo "active"; } ?>" href="#" onclick="switchlayout(2);"><i class="far fa-square-full"></i></a></li>
            </ul>
         </div>
       <?php } ?>
      </div>
   ...
   <div class="border-top border-bottom mb-2 clearfix">
      <div  class="search-options">
        ...
        $values = array(
			"1" => __("Male","premiumpress"), 
			"2" => __("Female","premiumpress"), 
			"3" => __("Couple","premiumpress"), 
			
			"4" => __("Trans Man","premiumpress"),
 			"5" => __("Trans Woman","premiumpress"),
 			"6" => __("Transsexual","premiumpress"),
			"7" => __("Non-binary","premiumpress"),
			
			"8" => __("Straight","premiumpress"),
			"9" => __("Gay","premiumpress"),
			"10" => __("Lesbian","premiumpress"),
			"11" => __("Bisexual","premiumpress"),
			
		);
		
		if(_ppt('hide_male') == 0){  unset($values['listvalues']["1"]);  }
		if(_ppt('hide_female') == 0){  unset($values['listvalues']["2"]);  }
		if(_ppt('hide_couples') == 0){  unset($values['listvalues']["3"]);  }
		if(_ppt('hide_transm') == 0){  unset($values['listvalues']["4"]);  }
		if(_ppt('hide_transw') == 0){  unset($values['listvalues']["5"]);  }
		if(_ppt('hide_trans') == 0){  unset($values['listvalues']["6"]);  }
		if(_ppt('hide_nonbinary') == 0){  unset($values['listvalues']["7"]);  }			
		if(_ppt('hide_straight') == 0){  unset($values['listvalues']["8"]);  }
		if(_ppt('hide_gay') == 0){  unset($values['listvalues']["9"]);  }
		if(_ppt('hide_lesbian') == 0){  unset($values['listvalues']["10"]);  }
		if(_ppt('hide_bisexual') == 0){  unset($values['listvalues']["11"]);  }
		 ?>
         <li class="ml-0"> 
         
         <div class="btn-group" id="gendersortbtn">
                  ...
                  <span class="pr-3" id="sortbymaintext"><span class="gendertitle text-muted font-weight-bold"><?php echo __("All Users","premiumpress") ?></span> </span>
                  </button>
                  <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                   <a href="javascript:void(0);" onclick="addgender('0');" id="genderfilter-0" class="dropdown-item"><?php echo __("All Users","premiumpress") ?></a>
            <?php foreach($values as $k => $v){ ?>
             
              <a href="javascript:void(0);" onclick="addgender('<?php echo $k; ?>');" id="genderfilter-<?php echo $k; ?>" class="dropdown-item"><?php echo $v ?></a>
            <?php } ?>
      ...
      <script>
         <?php if(isset($_GET['gender']) && is_numeric($_GET['gender']) ){ ?>
         jQuery(document).ready(function() {
         jQuery('#genderfilter-<?php echo $_GET['gender']; ?>').addClass('border-top border-bottom');
         jQuery('.gendertitle').html(jQuery('#gendersortbtn a.border-top.border-bottom').text());
         });
         <?php } ?>
      </script>
      <?php } ?>
            ...
            <li class="ml-0">        
               ...
               <div style="position: relative;">
                  ...
                  <input  type="text" class="form-control form-control-sm" style="border: 0px;
                     background: #fff;" name="s" value="<?php if(isset($_GET['s']) && strlen($_GET['s']) > 1){ echo esc_html($_GET['s']); } ?>" placeholder="<?php echo __("Enter keyword...","premiumpress"); ?>" />
               </div>
            </li>
            <?php } ?>
            
 <?php if(in_array(THEME_KEY, array('da')) && $wp_query->found_posts > 0 ){ ?>
  
             <li style="display:none;" class="age" id="pricesearchbit">
              <span class="float-left mr-3 font-weight-bold"><?php echo __("Age:","premiumpress"); ?> </span>
            ...
            <?php if(in_array(THEME_KEY, array('ct','mj','sp','rt','cm','at','so')) && $wp_query->found_posts > 0 ){ ?>
            <li style="display:none;" class="price" id="pricesearchbit">
            <span class="float-left mr-3 font-weight-bold"><?php echo __("Price:","premiumpress"); ?> </span>
            ...
            <li>
			   ...
			   ?>onclick="addnewfilter('nm1','s');"<?php }else{ ?>onclick="getCurrentLocation();"<?php } ?>> 
               
               <?php if(isset($_SESSION['mylocation'])){ ?>
               <span class="flag flag-<?php echo strtolower($_SESSION['mylocation']['country']); ?> wlt_locationflag"></span>
               <?php }else{ ?>
               <i class="fa fa-map-marker text-muted mr-1"></i> 
               <?php } ?>
               
               <span class="text-muted font-weight-bold">
               <?php if(isset($_SESSION['mylocation']) && isset($_SESSION['mylocation']['zip'])){ ?>
               <?php echo __("Near Me","premiumpress") ?>
               <?php }else{ ?>
               <?php echo __("Near Me","premiumpress") ?> 
               <?php } ?>
               </span>
            ...
            <li style="float:right">
               <div class="btn-group" id="displaysortbybtn">
                  <button id="btnGroupDrop1" type="button" class="btn sortbybtn dropdown-toggle  rounded-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="pr-3" id="sortbymaintext"><?php echo __("Sort By","premiumpress") ?>: <span class="sortbytitle text-muted font-weight-bold"><?php
				  
				  $sortby = isset( $_GET['sort'] ) ? esc_attr( $_GET['sort'] ) : _ppt('search_orderby');
				 switch($sortby){
				 
					 case "price": { 	echo __("Price","premiumpress"); } break;
					 case "hits": { 		echo __("Popularity","premiumpress"); } break;
					 case "featured": { 	echo __("Featured","premiumpress"); } break;
					 case "date": { 		echo __("Date","premiumpress"); } break;
					 case "ID": { 		echo __("Item ID","premiumpress"); } break;
					 
					 default: { echo __("Title","premiumpress");  }
                  ...
                  <?php if(in_array(THEME_KEY, array("dt")) &&  _ppt('search_maps') == 1 ){ ?>
                     <a href="javascript:void(0);" onclick="addnewfilter('nm1','s');" id="sortfilter-nm1" class="dropdown-item"><?php echo __("Distance (Nearest)","premiumpress") ?></a>     
                     <a href="javascript:void(0);" onclick="addnewfilter('nm2','s');" id="sortfilter-nm2" class="dropdown-item"><?php echo __("Distance (Furthest))","premiumpress") ?></a>
                     <?php } ?>
                  
                   <?php if(THEME_KEY == "da"){ ?>
                     <a href="javascript:void(0);" onclick="addnewfilter('da1','s');" id="sortfilter-da1" class="dropdown-item"><?php echo __("Age (High-Low)","premiumpress") ?></a>     
                     <a href="javascript:void(0);" onclick="addnewfilter('da2','s');" id="sortfilter-da2" class="dropdown-item"><?php echo __("Age (Low-High)","premiumpress") ?></a>
                     <?php } ?>
                  
                     <?php if(in_array(THEME_KEY, array('ct','mj','at','rt','sp','so'))){ ?>
                     <a href="javascript:void(0);" onclick="addnewfilter('s6','s');" id="sortfilter-s6" class="dropdown-item"><?php echo __("Price","premiumpress") ?> (<?php echo __("Highest","premiumpress") ?>)</a>  
                     <a href="javascript:void(0);" onclick="addnewfilter('s6a','s');" id="sortfilter-s6a"class="dropdown-item"><?php echo __("Price","premiumpress") ?> (<?php echo __("Lowest","premiumpress") ?>)</a>  
                     <?php } ?>
                     <?php if(THEME_KEY == "at"){ ?>
                     <a href="javascript:void(0);" onclick="addnewfilter('at2','s');" id="sortfilter-s8" class="dropdown-item"><?php echo __("Auction Ending","premiumpress") ?> (<?php echo __("Newest","premiumpress") ?>)</a>
                     <a href="javascript:void(0);" onclick="addnewfilter('at1','s');" id="sortfilter-s7" class="dropdown-item"><?php echo __("Auction Ending","premiumpress") ?> (<?php echo __("Oldest","premiumpress") ?>)</a>
                     <?php }elseif(THEME_KEY == "cp"){ ?>
                     <a href="javascript:void(0);" onclick="addnewfilter('cp1','s');" id="sortfilter-cp1" class="dropdown-item"><?php echo __("Times Used","premiumpress") ?></a>     
                     <a href="javascript:void(0);" onclick="addnewfilter('cp2','s');" id="sortfilter-cp2" class="dropdown-item"><?php echo __("Expiry Date","premiumpress") ?></a>
                     <?php } ?>
                    
                     <?php if(in_array(THEME_KEY, array('ct','sp','mj'))){ ?>
                     <a href="javascript:void(0);" onclick="addnewfilter('s1','s');" id="sortfilter-s1" class="dropdown-item"><?php echo __("Title","premiumpress") ?> (A-z)</a>
                     <a href="javascript:void(0);" onclick="addnewfilter('s1a','s');" id="sortfilter-s1a" class="dropdown-item"><?php echo __("Title","premiumpress") ?> (Z-a)</a>  
                     <?php } ?>
                               
                     <a href="javascript:void(0);" onclick="addnewfilter('s2','s');" id="sortfilter-s2" class="dropdown-item"><?php echo __("Date Added","premiumpress") ?> (<?php echo __("Newest","premiumpress") ?>)</a>
                     <a href="javascript:void(0);" onclick="addnewfilter('s2a','s');"  id="sortfilter-s2a" class="dropdown-item"><?php echo __("Date Added","premiumpress") ?> (<?php echo __("Oldest","premiumpress") ?>)</a>
                     <a href="javascript:void(0);" onclick="addnewfilter('s3','s');" id="sortfilter-s3" class="dropdown-item"><?php echo __("Popularity","premiumpress") ?> (<?php echo __("Most","premiumpress") ?>)</a>
                     <a href="javascript:void(0);" onclick="addnewfilter('s3a','s');"  id="sortfilter-s3a" class="dropdown-item"><?php echo __("Popularity","premiumpress") ?> (<?php echo __("Least","premiumpress") ?>)</a>
                     
                     <a href="javascript:void(0);" onclick="addnewfilter('s4','s');"  id="sortfilter-s4" class="dropdown-item"><?php echo __("Featured","premiumpress") ?> (<?php echo __("Top","premiumpress") ?>)</a>
      ...
      <?php if($wp_query->found_posts > 0){ ?>
      <script>
         <?php if(isset($_GET['ft']) && is_array($_GET['ft']) ){ ?>
            jQuery(document).ready(function() {
                     
                     <?php
            $al = array();
            $canC = true;
            	foreach(array_reverse($_GET['ft']) as $key => $val ){ if(in_array($val, $al)){ continue; } $al[] = $val; if($canC){ ?>
         
                       jQuery('#sortfilter-<?php echo $val; ?>').addClass('border-top border-bottom');
         				jQuery('.sortbytitle').html(jQuery('#displaysortbybtn a.border-top.border-bottom').text());
   ...
   <?php if(isset($_GET['ft']) && is_array($_GET['ft']) && ( in_array("nm1", $_GET['ft']) || in_array("nm2", $_GET['ft']) ) && isset($_SESSION['mylocation']['address']) ){  ?>
       <div class="col-12 px-0">
      <div class="alert alert-warning rounded-0 pb-3">
      <strong><?php echo __("Showing results near:","premiumpress") ?></strong> <span style="border-bottom:1px dotted #ffc107"><?php 
	  
	  if($_SESSION['mylocation']['address'] != ""){   echo $_SESSION['mylocation']['address']; }else{echo $_SESSION['mylocation']['country'];	} ?></span>
      <a href="javascript:void(0);" class="btn btn-warning btn-sm btn-ajax-location font-weight-bold float-right"><?php echo __("Change Location","premiumpress") ?></a>
      </div>
      </div>
   <?php }elseif(isset($_GET['ft']) && is_array($_GET['ft']) && ( in_array("nm1", $_GET['ft']) || in_array("nm2", $_GET['ft']) ) && !isset($_SESSION['mylocation']['address']) ){  ?>
       <div class="col-12 px-0">
      <div class="alert alert-danger rounded-0 pb-3">
      <span><?php echo __("Your current location is not set.","premiumpress") ?></span>
      <a href="javascript:void(0);" class="btn btn-danger btn-sm btn-ajax-location font-weight-bold float-right"><?php echo __("Set Location","premiumpress") ?></a>
      </div>
      </div>
   <?php } ?>
   ...
   <?php if(isset($_GET['zipcode']) && $_GET['zipcode'] != "" && isset($_GET['radius']) && is_numeric($_GET['radius']) && $_GET['radius'] < 150){ 
      $rv = $_GET['radius'];
      $rv1 = ($rv+10);
      $rv2 = ($rv-10);
   ...
   <div class="col-12 px-0">
      <div class="alert alert-warning rounded-0 pb-3">
         <div class="row">
            <div class="col-md-7">
               <h6 class="mt-2 mb-0"><?php echo str_replace("%a",$_GET['radius'], str_replace("%b", $_GET['zipcode'], str_replace("%c", $CORE->get_radius_unit(), __("Showing results within %a %c from %b","premiumpress")))); ?></h6>
               <?php
                  $saved_searches = get_option('wlt_saved_zipcodes');
                  if(isset($saved_searches[$_GET['zipcode']])){
                  ?>
               <small><i class="fa fa-map-marker"></i> <?php echo $saved_searches[$_GET['zipcode']]['address']; ?></small>
            ...
            <div class="col-md-5 text-right">
               <?php if($wp_query->found_posts > 0){ ?>
               <?php if($rv2 > 0){ ?>
               <a href="javascript:void(0);" onclick="increaseradius(<?php echo $rv2; ?>);"  class="btn btn-warning btn-sm float-right"><?php echo str_replace("%a",$rv2, str_replace("%b", $CORE->get_radius_unit(), __("Decrease to %a %b","premiumpress"))); ?></a>
               <?php } ?>
               <?php } ?>
               <?php if($rv1 < 130){ ?>
               <a href="javascript:void(0);" onclick="increaseradius(<?php echo $rv1; ?>);" class="btn btn-warning btn-sm float-right mr-2"><?php echo str_replace("%a",$rv1, str_replace("%b", $CORE->get_radius_unit(), __("Increase to %a %b","premiumpress"))); ?></a>
               <?php } ?>
            </div>
         </div>
      </div>
...
<?php if(THEME_KEY == "cp" && isset($GLOBALS['flag-taxonomy'])){  ?>

<?php include("_coupon/search-top-extra.php"); ?>

<?php }else{ ?>

   <ul class="list-unstyled style1list pb-0 clearfix hide-mobile mb-2" >
   
   <li class="font-weight-bold mr-2"><?php echo __("Only Show","premiumpress") ?>:</li>
      ...
      <li> 
         ...
         <?php echo __("Online Now","premiumpress") ?>  </label>
      </li>
      <?php } ?>
      ...
      <li> 
         ...
         <?php echo __("Used Today","premiumpress") ?>  </label>
      </li>
      <?php } ?>
      ...
      <li>     
         ...
         <?php echo __("My Favorites","premiumpress") ?>    </label>
      </li>
      <?php } ?>
      ...
      <li> 
         ...
         <?php echo __("Verified Users","premiumpress"); ?>    </label>
      </li>
      <?php } ?>
      ...
      <li> 
         ...
         <?php echo __("Power Sellers","premiumpress") ?> </label>
      </li>
      <?php } ?>
      <li> 
         <label class="checkbox">
         <input type="checkbox"  data-toggle="checkbox" onChange="addnewfilter('1','featuredonly');" <?php if(isset($_GET['featuredonly'])){ ?>checked=checked<?php } ?>><?php echo __("Featured","premiumpress") ?> 
         </label>
      </li>
      ...
      <li> 
         ...
         <?php echo __("Video Series","premiumpress") ?>  </label>
      </li>
      <li>
         <div class="mt-2 mx-2">
      ...
      <li> 
         <label class="checkbox">
         <input type="checkbox"  data-toggle="checkbox" onChange="addnewfilter('1','sold');" <?php if(isset($_GET['sold'])){ ?>checked=checked<?php } ?>>
         <?php echo __("Sold Jobs","premiumpress") ?> </label>
      </li>
      <?php } ?>
      <?php if(THEME_KEY == "dt"){ ?>
      <li> 
         ...
         <?php echo __("With Phone Number","premiumpress") ?> </label>
      </li>
      <?php } ?>
      <?php if(THEME_KEY == "at"){ ?>
      <li> 
         ...
         <?php echo __("Has Bids","premiumpress") ?> </label>
      </li>
      <?php } ?>
      <?php if(THEME_KEY == "sp"){ ?>
      <li>  
         ...
         <?php echo __("On Sale","premiumpress") ?>  </label>
      </li>
      <?php } ?>
      <?php if(THEME_KEY == "rt"){ ?>
      <li> 
      ...
      <li>
      <label class="checkbox">
         <input type="checkbox"  data-toggle="checkbox" onChange="addnewfilter('1','ptype<?php echo $k; ?>');" <?php if(isset($_GET['ptype'.$k])){ ?>checked=checked<?php } ?>> <?php echo $v['name']; ?>  </label>
      </li>
      <?php } ?>
      <li class=" mr-lg-2">
...
if(THEME_KEY == "cp" && isset($GLOBALS['flag-taxonomy'])){ }else{ ?>
<div class="col-12 col-md-2">
<a href="javascript:void(0);" class="btn-block mt-lg-2 my-2 my-md-0 btn btn-sm btn-primary" onclick="jQuery('#mainfilterlist').toggle();"><?php echo __("More Filters","premiumpress") ?> 
      ...
      <div class="widget widget-mainsearchbox">
         <div class="main-search-filter">
            ...
            <script>
               ...
               <?php
                  if( ( !isset($_GET['display']) && in_array( THEME_KEY, array("sp","cm","da")) ) || ( isset($_GET['display']) && $_GET['display'] == 2 ) ){ 
                  ?>
               jQuery(document).ready(function() {
               MakeFullPageLay();
               });
            ...
            <?php } ?> 
            <?php if(THEME_KEY == "mj"){ ?>
            <div class="card addcheck border-0">
               ...
               <ul class="list-group list-group-flush">
                  ...
                  <li><i class="fa fa-dropbox text-dark mr-2 ml-1"></i> 
                     ...
                     <label class="checkbox float-right"><input type="checkbox"  data-toggle="checkbox" onChange="addnewfilter('1','delivery2');" <?php if(isset($_GET['delivery2'])){ ?>checked=checked<?php } ?>></label> 
                  </li>
                  <li><i class="fa fa-dropbox text-dark mr-2 ml-1"></i>  <?php echo __("14 Days","premiumpress") ?> 
                     <label class="checkbox float-right"> <input type="checkbox"  data-toggle="checkbox" onChange="addnewfilter('1','delivery3');" <?php if(isset($_GET['delivery3'])){ ?>checked=checked<?php } ?>></label> 
                  </li>
                  <li><i class="fa fa-dropbox text-dark mr-2 ml-1"></i>  <?php echo __("1 Month","premiumpress") ?>  
                     <label class="checkbox float-right"> <input type="checkbox"  data-toggle="checkbox" onChange="addnewfilter('1','delivery4');" <?php if(isset($_GET['delivery4'])){ ?>checked=checked<?php } ?>></label> 
                  </li>
               </ul>
            </div>
            <?php } ?> 
            ...
            <div class="card colapse border-0">
               ...
               <ul class="list-group list-group-flush addcount">
                  ...
                  <?php foreach($query as $val){
                     ...
                     if($country == ""){ continue; }
                     ?>
                  <li data-type="country" data-value="<?php echo $code; ?>"  id="filter-country<?php echo $code; ?>">
            ...
            <div class="card colapse border-0">
               ...
               <ul class="list-group list-group-flush addcount">
                  ...
                  <li data-type="hits" data-value="p1" id="filter-p1"><a href="javascript:void(0);" onclick="addnewfilter('p1','p');">&lt; 10 <?php echo __("Views","premiumpress") ?></a></li>
                  <li data-type="hits" data-value="p2" id="filter-p2"><a href="javascript:void(0);" onclick="addnewfilter('p2','p');">&gt;10 <?php echo __("Views","premiumpress") ?></a></li>
                  <li data-type="hits" data-value="p3" id="filter-p3"><a href="javascript:void(0);" onclick="addnewfilter('p3','p');">&gt;100 <?php echo __("Views","premiumpress") ?></a></li>
                  <li data-type="hits" data-value="p4" id="filter-p4"><a href="javascript:void(0);" onclick="addnewfilter('p4','p');">&gt;1,000 <?php echo __("Views","premiumpress") ?></a></li>
               </ul>
            </div>
            <div class="card colapse addcheck border-0">
               <div class="card-header  rounded-0"><?php echo __("User Rating","premiumpress");  ?></div>
...
<?php if(in_array(THEME_KEY, array("dt")) && _ppt('search_maps') == 1 ){ ?>
<?php get_template_part( 'search', 'map' ); ?>
<?php } ?>